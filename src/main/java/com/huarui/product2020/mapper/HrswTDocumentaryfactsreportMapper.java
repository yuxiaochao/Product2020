 ...
 * @since 2018-10-17
 */
public interface HrswTDocumentaryfactsreportMapper extends BaseMapper<HrswTDocumentaryfactsreport> {
	...
	public List queryFactsReportHistory(IPageByMap page,Map map)throws Exception;
