package com.huarui.common.sdk.alipay.util;

import com.huarui.common.sdk.alipay.config.AlipayConfig;
import com.huarui.common.sdk.alipay.sign.MD5;
...
public class AlipaySubmit {
     ...
     * pid 合作伙伴ID
     */
	public static String query_timestamp(String pid) throws MalformedURLException,
                                                        DocumentException, IOException {

        //构造访问query_timestamp接口的URL串
        String strUrl = ALIPAY_GATEWAY_NEW + "service=query_timestamp&partner=" + pid + "&_input_charset" + AlipayConfig.input_charset;
